...
class LogSetup:
    ...
    >>> logger = logging.getLogger("pal_found_cli.common.retry")
...
def get_logger(name: str) -> logging.Logger:
    ...
    ----------
    name : str
        Logger name, typically the module path (e.g., 'pal_found_cli.common.retry').
    ...
    Examples
    --------
    >>> logger = get_logger("pal_found_cli.common.retry")
    >>> logger.warning(
